...
//tambahan
  ...
  $tambah=mysqli_query($con,"INSERT INTO mitra VALUES ('$nip','$nama','$sex','$gol', '$pang', '$jab', null, null, 'na')");
  $query = mysqli_query($con,"UPDATE mitra set nama_karyawan='$nama', NIP='$nip', JK='$sex', Golongan='$gol', Pangkat='$pang', Jabatan='$jab' where NIP='$nip'"); 
...
//$query = "INSERT INTO temp VALUES (null,'$data1','$data2', '$data3', '$data4', '$data5', '$created_by', '$date')";
$tempo = "INSERT INTO temp VALUES (null,'$nip','$nama','$krit1','$krit2', '$krit3', '$krit4', '$created_by', '$date', '$period')";
$update = "UPDATE temp SET NIP='$nip', nama_mitra='$nama', Pengajaran='$krit1', Penelitian & Publikasi='$krit2', Pengabdian Masyarakat='$krit3', Penunjang='$krit4', creator='$created_by', waktu='$date' , periode='$period' where NIP='$nip' and periode='".$period."'";
$hasil = mysqli_query($con, $tempo);
$ubah = mysqli_query($con, $update);
...
$sql = "INSERT into alternatif values(null, '$nip', '$period', 0)";
      ...
      $con->query($sql);
      $last_id = $con->insert_id;
      $dos="UPDATE mitra SET status='ok' where nip='$nip' and periode='$period'";
      $con->query($dos);
