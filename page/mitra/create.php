<?php 
  error_reporting(0);
   ...
   //     window.location.href='index.php?p=mitra&act=create&s=dm&nip=".$_POST[NIP]."&nama=".$_POST[mitra]."&JK=".$_POST[JK]."&uname=".$_POST[username]."&jabatan=".$_POST[jabatan]."&uname=".$_POST[username]."'</script>";
   //   }
   //   else{
    if (isset($_POST['simpan'])) {
      ...
      $sql = "INSERT INTO mitra (nama_mitra, JK, jabatan, status) VALUES ('$mitra', '$JK', '$jabatan', 'na')";
      $query = mysqli_query($con, $sql);
  
      if ($query) {
          echo "<script>alert('Data berhasil ditambahkan!');window.location.href='index.php?p=mitra'</script>";
      } else {
    ...
    <div class="col-md-8">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Form mitra</h3>
        ...
        <form role="form" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control input-lg" id="exampleInputEmail1" placeholder="Masukan Nama mitra" name="mitra" value="<?php echo $data['nama_mitra']; ?>"required>
            </div>
            <div class="form-group">
