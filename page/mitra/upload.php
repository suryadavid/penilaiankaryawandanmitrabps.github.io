...
<div class="col-lg-5">
<h2>Import Data Mitra <br><small>Periode <?php echo $_GET['ta'];?><small></h2>
<form method="post" enctype="multipart/form-data" action="page/mitra/import.php">
...
<div class="col-lg-7">
	<?php 
	$imp=mysqli_query($con,"SELECT * FROM mitra where periode='$ta' order by nama_mitra");
...
<?php } ?>
	<?php $no=1;
        ...
        echo "<thead><tr><th>No.</th><th>NIP</th><th>Nama mitra</th><th>Jenis Kelamin</th><th>Golongan</th><th>Pangkat</th><th>Jabatan</th></tr></thead><tbody>";
        while($row = mysqli_fetch_array($imp)){
        	 		if($row['nama_mitra']=='Tinkywinky'){
                        $style="style='background: #551a8b;color:white;'";
                      }elseif($row['nama_mitra']=='Dipsy'){
                        $style="style='background: #9DD744;color:white;'";
                      }elseif($row['nama_mitra']=='Lala'){
                        $style="style='background: #f2eb0d;color:black;'";
                      }elseif($row['nama_mitra']=='Poo'){
          ...
          echo "<td class='num'>".$row['NIP']."</td>";
        	echo "<td $style>".$row['nama_mitra']."</td>";
        	echo "<td>".$row['JK']."</td>";
