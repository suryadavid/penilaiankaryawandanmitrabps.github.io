...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>Kinerja</b> <b>Plus</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
         ...
         <!--  <li class="dropdown user user-menu">
          ...
          <?php if (@$_SESSION['logged'] == 1): ?>
            <li><a class="dropdown-item" href="?p=mitra">Data Mitra</a></li>
          <!-- <li><a class="dropdown-item" href="?p=alternatif">Penilaian karyawan</a></li> -->
         <!--  <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRN9igcyo_jp2dYcTSY3qY-o-CY7u4Unb3yWtDJjS5Udj0uBswAZg" class="user-image" alt="User Image">
          ...
          <?php endif ?>
          <?php if (@$_SESSION['logged'] == 2 || @$_SESSION['logged'] == 1): ?>
          <li><a class="dropdown-item" href="?p=alternatif">Penilaian Mitra</a></li>
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRN9igcyo_jp2dYcTSY3qY-o-CY7u4Unb3yWtDJjS5Udj0uBswAZg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?= $_SESSION['name'] ?></span>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <?php if (@$_SESSION['logged'] == 1): ?>
          ...
          <li class="treeview <?= (@$_GET['p']=='mitra')?'active':'' ?>">
            <a href="#">
              <i class="fa fa-user-secret"></i> <span>Mitra</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="?p=mitra&act=create"><i class="fa fa-circle-o"></i> Tambah data Mitra </a></li>
              <li><a href="?p=mitra"><i class="fa fa-circle-o"></i> Data Mitra</a></li>
            </ul>
          </li>
        ...
        <?php 
          ...
          switch ($page) {
            ...
            case 'karyawan':
              ...
              case 'mitra':
                if ($action == "create") {
                  include 'page/mitra/create.php';
                }else if ($action == "edit") {
                  include 'page/mitra/edit.php';
                }else if ($action == "upload") {
                  include 'page/mitra/upload.php';
                } else {
                  include 'page/mitra/index.php';
                }
                break;
...
<!-- ./wrapper -->
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="https://madiunkota.bps.go.id/">BPS KOTA MADIUN</a>.</strong>
  </footer>
